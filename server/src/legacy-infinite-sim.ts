// Frozen legacy Infinite engine retained only as the differential oracle for
// infinite-mode.equivalence.test.ts. Production and ordinary server tests use
// infinite@1 from sim-core through sim.ts.
// ─────────────────────────────────────────────────────────────────────────────
